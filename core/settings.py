...
ALLOWED_HOSTS = ['139.59.16.101', 'hrms.thethoughtfactory.ae', 'www.hrms.thethoughtfactory.ae','127.0.0.1']
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/home/thethethoughtfactory/Documents/hrms_31-01-22/logs/warning.log',
        },
    },
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'hrmsttf@gmail.com'

...
class CompensatoryRequest_DetailForm(forms.ModelForm):  
    ...
    class Meta:  
       ...
       # fields = "__all__",   "mobile_number",  "employee",
        ...
        fields = ["worked_date", "duration", "unit", "employee" ] #     ] #"role", "department") #"date_of_joining")
    ...
    #     self.fields['from_time'].error_messages = {'required': 'From time is required'}
        
    #     self.fields['to_time'].required = True
    #     self.fields['to_time'].widget.attrs['required'] = 'required'
    #     self.fields['to_time'].error_messages = {'required': 'To time is required'}  

...
#    user = models.ForeignKey(Group, related_name='role', on_delete=models.CASCADE)
   ...
   # location = models.CharField(max_length=50, blank = True, null = True)  
    location = models.ForeignKey(Location, blank=True, related_name='location_emp', null=True, on_delete= models.SET_NULL)
    ...
    passport_num = models.CharField(max_length=200, blank = True, null = True)  
    passport_exp_date = models.DateField( blank = True, null = True)  
    psssport_url = models.FileField(max_length=254, blank = True, null = True)
